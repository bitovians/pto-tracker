...
System.bundles = {"bundles/pto/app.css!":["styles.less!steal-less@1.3.4#less"],"bundles/pto/components/dashboard/dashboard":["lodash@4.17.11#lodash","xml-js@1.6.9#dist/xml-js","moment@2.23.0#moment","pto@1.0.0#models/time-entries","pto@1.0.0#components/dashboard/dashboard.stache!steal-stache@4.1.2#steal-stache","pto@1.0.0#components/dashboard/dashboard"],"bundles/pto/components/authenticate/authenticate":["pto@1.0.0#components/authenticate/authenticate.stache!steal-stache@4.1.2#steal-stache","pto@1.0.0#components/authenticate/authenticate"]};
/*npm-utils*/
...
define('pto@1.0.0#models/api-info', [
    'exports',
    'can-define@2.7.8#map/map',
    'can@5.21.5#enable-can-debug',
    'can-component@4.4.11#can-component'
...
/*pto@1.0.0#components/loading/loading.stache!steal-stache@4.1.2#steal-stache*/
define('pto@1.0.0#components/loading/loading.stache!steal-stache@4.1.2#steal-stache', [
    'module',
    'can-stache',
...
/*pto@1.0.0#components/loading/loading*/
define('pto@1.0.0#components/loading/loading', [
    'pto@1.0.0#components/loading/loading.stache!steal-stache@4.1.2#steal-stache',
    'can-component@4.4.11#can-component',
    'can@5.21.5#enable-can-debug',
    'can-define@2.7.8#map/map'
...
/*pto@1.0.0#app.stache!steal-stache@4.1.2#steal-stache*/
define('pto@1.0.0#app.stache!steal-stache@4.1.2#steal-stache', [
    'module',
    'can-stache',
    'can-stache/src/mustache_core',
    'can-view-import@4.2.1#can-view-import',
...
define('pto@1.0.0#app', [
    ...
    'pto@1.0.0#components/loading/loading',
    'pto@1.0.0#components/loading/loading.stache!steal-stache@4.1.2#steal-stache'
], function (_apiInfo, _pto100AppStacheStealStache, _canComponent) {
    'use strict';
    var _apiInfo2 = _interopRequireDefault(_apiInfo);
    var _pto100AppStacheStealStache2 = _interopRequireDefault(_pto100AppStacheStealStache);
    var _canComponent2 = _interopRequireDefault(_canComponent);
    function _interopRequireDefault(obj) {
        return obj && obj.__esModule ? obj : { default: obj };
    }
    _canComponent2.default.extend({
        tag: 'bitovian-pto',
        view: _pto100AppStacheStealStache2.default,
        ViewModel: {
            get isAuthenticated() {
