...
System.bundles = {"bundles/bitovian-pto/app.css!":["styles.less!steal-less@1.3.4#less"],"bundles/bitovian-pto/components/dashboard/dashboard":["lodash@4.17.11#lodash","xml-js@1.6.9#dist/xml-js","moment@2.23.0#moment","bitovian-pto@1.0.0#models/time-entries","bitovian-pto@1.0.0#components/dashboard/dashboard.stache!steal-stache@4.1.2#steal-stache","bitovian-pto@1.0.0#components/dashboard/dashboard"],"bundles/bitovian-pto/components/authenticate/authenticate":["bitovian-pto@1.0.0#components/authenticate/authenticate.stache!steal-stache@4.1.2#steal-stache","bitovian-pto@1.0.0#components/authenticate/authenticate"]};
/*npm-utils*/
...
define('package.json!npm', [
    ...
    if (!loader.main) {
        loader.main = 'bitovian-pto@1.0.0#app';
    }
...
define('can-define@2.7.8#can-define', [
    'require',
    'exports',
    'module',
    'can-namespace',
...
define('can-define@2.7.8#ensure-meta', [
    'require',
    'exports',
    'module',
    'can-symbol',
...
define('can-define@2.7.8#define-helpers/define-helpers', [
    'require',
    'exports',
    'module',
    'can-define',
...
define('can-define@2.7.8#map/map', [
    'require',
    'exports',
    'module',
    'can-construct',
...
define('can@5.21.5#enable-can-debug', ['can-debug@2.0.5#can-debug'], function (_canDebug) {
    'use strict';
...
define('can-define@2.7.8#list/list', [
    'require',
    'exports',
    'module',
    'can-construct',
...
define('bitovian-pto@1.0.0#models/api-info', [
    'exports',
    'can-define@2.7.8#map/map',
    'can@5.21.5#enable-can-debug',
    'can-component@4.4.11#can-component'
...
/*bitovian-pto@1.0.0#components/loading/loading.stache!steal-stache@4.1.2#steal-stache*/
define('bitovian-pto@1.0.0#components/loading/loading.stache!steal-stache@4.1.2#steal-stache', [
    'module',
    'can-stache',
...
/*bitovian-pto@1.0.0#components/loading/loading*/
define('bitovian-pto@1.0.0#components/loading/loading', [
    'bitovian-pto@1.0.0#components/loading/loading.stache!steal-stache@4.1.2#steal-stache',
    'can-component@4.4.11#can-component',
    'can@5.21.5#enable-can-debug',
    'can-define@2.7.8#map/map'
...
/*bitovian-pto@1.0.0#app.stache!steal-stache@4.1.2#steal-stache*/
define('bitovian-pto@1.0.0#app.stache!steal-stache@4.1.2#steal-stache', [
    'module',
    'can-stache',
    'can-stache/src/mustache_core',
    'can-view-import@4.2.1#can-view-import',
...
/*bitovian-pto@1.0.0#app*/
define('bitovian-pto@1.0.0#app', [
    'bitovian-pto@1.0.0#models/api-info',
    'bitovian-pto@1.0.0#app.stache!steal-stache@4.1.2#steal-stache',
    'can-component@4.4.11#can-component',
    ...
    'bitovian-pto@1.0.0#components/loading/loading',
    'bitovian-pto@1.0.0#components/loading/loading.stache!steal-stache@4.1.2#steal-stache'
], function (_apiInfo, _bitovianPto100AppStacheStealStache, _canComponent) {
    'use strict';
    var _apiInfo2 = _interopRequireDefault(_apiInfo);
    var _bitovianPto100AppStacheStealStache2 = _interopRequireDefault(_bitovianPto100AppStacheStealStache);
    var _canComponent2 = _interopRequireDefault(_canComponent);
    function _interopRequireDefault(obj) {
        return obj && obj.__esModule ? obj : { default: obj };
    }
    _canComponent2.default.extend({
        tag: 'bitovian-pto',
        view: _bitovianPto100AppStacheStealStache2.default,
        ViewModel: {
            get isAuthenticated() {
